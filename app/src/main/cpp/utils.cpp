...
void bitmap2Mat(JNIEnv *env, Mat *mat,  jobject bitmap,bool needPremultiplyAlpha = 0){
...
jobject createBitmap(JNIEnv *env, Mat &srcData, jobject config){
    jclass cls_bitmap = env->FindClass("android/graphics/Bitmap");
    jmethodID mid_bitmap = env->GetStaticMethodID(cls_bitmap, "createBitmap",
            "(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;");
    jobject bitmap = env->CallStaticObjectMethod(cls_bitmap, mid_bitmap, srcData.cols, srcData.rows, config);
